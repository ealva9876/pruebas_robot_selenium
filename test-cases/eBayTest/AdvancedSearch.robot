...
Search Google ebay sampe test
    ...
    HeaderPage.Input Search Text and Click Search    ${REF_PALABRA_CLAVE}    ${EBAY_INPUT_TEXT}    ${EBAY_SEARCH_BUTTON}
...
Enter Keyword
    [Arguments]     ${keyword}
    Input Text      ${EBAY_INPUT_TEXT}     ${keyword}

Click Search Button    
    Wait Until Element Is Visible       ${EBAY_INPUT_TEXT}
